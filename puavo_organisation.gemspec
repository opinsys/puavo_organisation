Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "init.rb", "README.rdoc", "lib"b, "lib/puavo_organisation.rb", "lib/puavo", "lib/puavo/organisation.rb", "lib/puavo_organisation", "lib/puavo_organisation/controllers", "lib/puavo_organisation/controllers/helpers.rb", "rails", "rails/init.rb"]
  s.require_path = "lib"
  s.has_rdoc = false
